...
// public Intake() {
// intakePivotMotor = new TalonFX(mapIntake.INTAKE_PIVOT_CAN); // Intake pivot
// motor
// coralIntakeMotor = new TalonFX(mapIntake.CORAL_INTAKE_CAN); // Coral left
// intake motor
// algaeIntakeMotor = new TalonFX(mapIntake.INTAKE_ALGAE_CAN); // Algae intake
// motor
// coralSensor = new CANrange(mapIntake.CORAL_INTAKE_SENSOR); // Coral intake
// sensor
...
// double intakeAcceleration =
// algaeIntakeMotor.getAcceleration().getValueAsDouble();

// Current intakeHasGamePieceCurrent = constIntake.ALGAE_INTAKE_HAS_GP_CURRENT;
// AngularVelocity intakeHasGamePieceVelocity =
// constIntake.ALGAE_INTAKE_HAS_GP_VELOCITY;
