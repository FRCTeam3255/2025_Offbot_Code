...
public final class Constants {
  ...
  public static class constIntake {
    ...
    static {
      ...
      INTAKE_PIVOT_CONFIG.Feedback.SensorToMechanismRatio = 1454 / 25;// just like intake pivot, we still need
  ...
  public static class constElevator {
    ...
    static {
      ...
      ELEVATOR_PIVOT_CONFIG.Feedback.SensorToMechanismRatio = 11111 / 100;// just like intake pivot, we still need
                                                                          // to get the ratio from fab
