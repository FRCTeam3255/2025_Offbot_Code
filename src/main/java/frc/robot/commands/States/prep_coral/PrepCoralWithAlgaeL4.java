...
public class PrepCoralWithAlgaeL4 extends StateCommand {
  @Override
  ...
  protected RobotState getDesiredState() {
    return RobotState.PREP_CORAL_L4_WITH_ALGAE;
  }
  ...
  public void initialize() {
    ...
    if (backwards) {
      RobotContainer.subMotion.setAllPosition(constMechanismPositions.PREP_CORAL_L4_BACKWARDS);
    } else {
      RobotContainer.subMotion.setAllPosition(constMechanismPositions.PREP_CORAL_L4_FORWARDS);
    }
  }
}
