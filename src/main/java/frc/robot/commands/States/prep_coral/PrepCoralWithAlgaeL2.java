...
public class PrepCoralWithAlgaeL2 extends StateCommand {
  @Override
  ...
  protected RobotState getDesiredState() {
    return RobotState.PREP_CORAL_L2_WITH_ALGAE;
  }
  ...
  public void initialize() {
    ...
    if (backwards) {
      RobotContainer.subMotion.setAllPosition(constMechanismPositions.PREP_CORAL_L2_BACKWARDS);
    } else {
      RobotContainer.subMotion.setAllPosition(constMechanismPositions.PREP_CORAL_L2_FORWARDS);
    }
  }
}
