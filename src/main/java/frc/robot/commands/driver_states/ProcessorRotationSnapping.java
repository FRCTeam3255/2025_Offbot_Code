...
public class ProcessorRotationSnapping extends Command {
  /** Creates a new ProcessorRotationSnapping. */
  ...
  public ProcessorRotationSnapping(Drivetrain subDrivetrain, DriverStateMachine subDriverStateMachine,
